...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'enterAccessCode': 'Enter the admin code to access the catalog.',
    ...
    'storeClosedMay5': 'The store closed on 5/5. Ordering is no longer available.',
    'email': 'Email',
  ...
  fr: {
    ...
    'enterAccessCode': 'Entrez le code administrateur pour accéder au catalogue.',
    'accessCode': 'Code administrateur',
    'accessCodePlaceholder': 'Entrez le code administrateur',
    'accessCodeRequired': 'Veuillez entrer le code administrateur',
    'accessCodeInvalid': 'Code invalide. Veuillez réessayer.',
    'storeClosedMay5': 'La boutique a fermé le 5/5. Les commandes ne sont plus possibles.',
    'email': 'E-mail',
